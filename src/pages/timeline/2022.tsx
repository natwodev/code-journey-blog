      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-20">
        ...
        >
          ...
          <motion.div
            ...
            className="mb-12"
          >
            <div className="text-brand-cyan/90 text-sm font-medium mb-2">{t('common.milestone')}: 2022</div>
            <h1 className="text-3xl sm:text-4xl md:text-5xl font-poppins font-bold mb-4">
              {t('timeline.2022.title')}
            </h1>
            <p className="text-white/80 text-lg leading-relaxed">
              {t('timeline.2022.description')}
            </p>
          </motion.div>
          ...
          >
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <h2 className="text-xl font-semibold mb-4 flex items-center gap-3">
                ...
                {t('timeline.2022.university.title')}
              </h2>
              <p className="text-white/80 leading-relaxed">
                {t('timeline.2022.university.description')}
              </p>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <h2 className="text-xl font-semibold mb-4 flex items-center gap-3">
                ...
                {t('timeline.2022.programmingLanguages.title')}
              </h2>
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  <h3 className="font-semibold text-brand-cyan mb-2">{t('timeline.2022.programmingLanguages.c.title')}</h3>
                  <p className="text-white/70 text-sm">
                    {t('timeline.2022.programmingLanguages.c.description')}
                  </p>
                </div>
                <div className="bg-white/5 border border-white/10 rounded-xl p-4">
                  <h3 className="font-semibold text-brand-cyan mb-2">{t('timeline.2022.programmingLanguages.cpp.title')}</h3>
                  <p className="text-white/70 text-sm">
                    {t('timeline.2022.programmingLanguages.cpp.description')}
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <h2 className="text-xl font-semibold mb-4 flex items-center gap-3">
                ...
                {t('timeline.2022.learnings.title')}
              </h2>
              <ul className="space-y-3">
                {(t('timeline.2022.learnings.items', { returnObjects: true }) as string[]).map((item: string) => (
                  <li key={`learning-2022-${item.slice(0, 10).replace(/\s+/g, '-')}`} className="flex items-start gap-3">
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
              <h2 className="text-xl font-semibold mb-4 flex items-center gap-3">
                ...
                {t('timeline.2022.challenges.title')}
              </h2>
              <p className="text-white/80 leading-relaxed">
                {t('timeline.2022.challenges.description')}
              </p>
            </div>
          </motion.div>
        </motion.div>
